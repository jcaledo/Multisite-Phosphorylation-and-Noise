...
Note: This document form part of the Supplementary Material accompaning to the paper *Multisite Phosphorylation Provides a Reliable Mechanism for Making Decisions in Noisy Environments.* The corresponding R Markdown can be downloaded from either https://goo.gl/57ssTK or  https://github.com/jcaledo/Multisite_Phosphorylation_and_Noise
